...
public interface PlanRepository extends JpaRepository<Plan, UUID> {
    ...
    // Tous les forfaits d'un hotspot (actifs + inactifs) — dashboard propriétaire
    List<Plan> findAllByHotspotIdOrderByDisplayOrderAscCreatedAtAsc(String hotspotId);

    // Uniquement les forfaits actifs — portail captif public
    ...
    /** Utilisé par PlanLimitService */
    long countByHotspotId(String hotspotId);
